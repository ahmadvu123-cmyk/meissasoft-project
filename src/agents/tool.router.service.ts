...
export class ToolRouterService {
    ...
    async selectToolWithLLM(query: string) {
        const prompt = `
                ...
                Your job is to classify the user query into ONE of these categories based on meaning.
                ...
                5. attendance_trend (ANALYZE_ATTENDANCE) → user asks about attendance behavior using present/absent days.
                Example: "Analyze attendance consistency of the worker"

                6. analyze_salary (ANALYZE_SALARY) → user asks about salary breakdown, net salary, base salary, or payment status.
                ...
                IMPORTANT RULES:
                    ...
                    - Return ONLY ONE value exactly as written below:
